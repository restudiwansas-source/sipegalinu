    ...
    <div className="admin-overlay">
      ...
      <div className="admin-panel">
          ...
          <div className="p-4 space-y-2 overflow-y-auto">
            ...
            {menu.map(([id,Icon,label])=>(
              ...
              <button
                ...
                className={`w-full p-4 rounded-2xl flex items-center gap-3 font-bold ${
                  active===id
                    ? "bg-emerald-600"
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <div className="md:hidden flex gap-2 p-3 overflow-x-auto bg-zinc-900 border-b border-zinc-800">
...
function Dashboard(){
  ...
  return (
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      <AdminStat
        title="Menu Aktif"
        value={menus.filter(m=>m.enabled).length}
      />
...
function AdminStat({title,value}){
  ...
  return(
    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
      ...
      <div className="text-zinc-400 text-xs uppercase font-black tracking-widest">
        {title}
      </div>
